...
@Component({
  selector: 'app-ogranizator-detail-turnir',
  templateUrl: './ogranizator-detail-turnir.component.html',
  styleUrls: ['./ogranizator-detail-turnir.component.css'],
  standalone: true,
  imports: [CommonModule, SpinnerComponent, MatDividerModule],
})
export class OgranizatorDetailTurnirComponent implements OnInit {
