...
@Component({
  selector: 'app-organizator-tim',
  templateUrl: './organizator-tim.component.html',
  styleUrls: ['./organizator-tim.component.css'],
  standalone: true,
  imports: [MatDividerModule, CommonModule, PaginatorComponent, SpinnerComponent, MatCardModule, MatChipsModule],
})
export class OrganizatorTimComponent implements OnInit {
